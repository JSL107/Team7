...
public class AccommodationCSVParser implements AccommodationParser {
   ...
   public AccommodationDTO parseFrom(String line) {
        ...
        final String city = columns[0];
        final String accommodationName = columns[1];
        final String address = columns[2];
        final String phoneNumber = columns[3];

        AccommodationDTO accommodation = new AccommodationDTO(city, accommodationName, address, phoneNumber);
